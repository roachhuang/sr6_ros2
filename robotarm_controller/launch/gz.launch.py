...
def generate_launch_description():
    ...
    package_name_gazebo = 'robotarm_controller'
    package_name_bringup = 'bringup'
    package_name_description = 'smallrobot_description'
    package_name_moveit = 'smallrobot_moveit'

    default_robot_name = 'samllrobot'
    gazebo_models_path = 'models'
    # default_world_file = 'pick_and_place_demo.world'
    default_world_file = 'empty_world.world'
