...
namespace robotarm_controller
{
    ...
    public:
        ...
        hw::CallbackReturn on_init(
            const hw::HardwareComponentInterfaceParams & params) override;
    ...
    private:
        ...
        const std::vector<double> lower_limit_ = {-114.0, -81.0, -180.0, -180.0, -139.0, -180.0, -0.57, -0.57};
        const std::vector<double> upper_limit_ = {114.0, 77.0, 70.0, 180.0, 139.0, 180.0, 1.09, 1.09};
